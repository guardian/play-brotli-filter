/*
 *    Copyright 2020-2022, Aayush Atharva
 *
 ...
 */
package play.filters.brotli.loader;
 ...
 */
public class BrotliNativeLoader {
    ...
    static {
        ...
        try {
            ...
            try {
                ...
                File tempDir = new File(System.getProperty("java.io.tmpdir"), "play_filters_brotli_" + System.nanoTime());
                tempDir.mkdir();
                tempDir.deleteOnExit();

                File tempFile = new File(tempDir, nativeLibName);

                try (InputStream in = BrotliNativeLoader.class.getResourceAsStream(libPath)) {
